...
final class EORTests: XCTestCase {
    ...
    func testImmediate() throws {
        ...
        nes.memory.storage[0x00] = nes.cpu.opcode(.eor, .immediate)
    ...
    func testZeroPage() throws {
        let nes = Nes()
        nes.cpu.registers.a = 0xCC
        nes.memory.storage[0x00] = nes.cpu.opcode(.eor, .zeroPage)
    ...
    func testZeroPageX() throws {
        ...
        nes.memory.storage[0x00] = nes.cpu.opcode(.eor, .zeroPageX)
        nes.memory.storage[0x01] = 0x42
    ...
    func testAbsolute() throws {
        let nes = Nes()
        nes.cpu.registers.a = 0xCC
        nes.memory.storage[0x00] = nes.cpu.opcode(.eor, .absolute)
        nes.memory.storage[0x01] = 0x80
    ...
    func testAbsoluteX() throws {
        ...
        nes.memory.storage[0x00] = nes.cpu.opcode(.eor, .absoluteX)
        nes.memory.storage[0x01] = 0x80
        nes.memory.storage[0x02] = 0x01
    ...
    func testAbsoluteY() throws {
        ...
        nes.memory.storage[0x00] = nes.cpu.opcode(.eor, .absoluteY)
        nes.memory.storage[0x01] = 0x80
        nes.memory.storage[0x02] = 0x01
        nes.memory.storage[0x0181] = 0x84
        nes.start(cycles: 4)
    ...
    func testIndexedIndirect() throws {
        ...
        nes.memory.storage[0x00] = nes.cpu.opcode(.eor, .indexedIndirect)
    ...
    func testIndirectIndexed() throws {
        ...
        nes.memory.storage[0x00] = nes.cpu.opcode(.eor, .indirectIndexed)
        nes.memory.storage[0x01] = 0x02

...
final class BCSTests: XCTestCase {
    ...
    func testIf() throws {
        ...
        nes.memory.storage[0x00] = nes.cpu.opcode(.bcs, .relative)
    ...
    func testIfNewPage() throws {
        ...
        nes.cpu.registers.carryFlag = true
        nes.memory.storage[0x00FC] = nes.cpu.opcode(.bcs, .relative)
    ...
    func testIfBackwards() throws {
        ...
        nes.cpu.registers.pc = 0x00FC
        nes.cpu.registers.carryFlag = true
        nes.memory.storage[0xFC] = nes.cpu.opcode(.bcs, .relative)
    ...
    func testElseNewPage() throws {
        ...
        nes.cpu.registers.carryFlag = false
        nes.memory.storage[0x00FE] = nes.cpu.opcode(.bcs, .relative)

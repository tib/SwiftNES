...
final class BMITests: XCTestCase {
    ...
    func testIf() throws {
        ...
        nes.memory.storage[0x00] = nes.cpu.opcode(.bmi, .relative)
    ...
    func testIfNewPage() throws {
        ...
        nes.cpu.registers.signFlag = true
        nes.memory.storage[0x00FC] = nes.cpu.opcode(.bmi, .relative)
    ...
    func testIfBackwards() throws {
        ...
        nes.cpu.registers.pc = 0x00FC
        nes.cpu.registers.signFlag = true
        nes.memory.storage[0xFC] = nes.cpu.opcode(.bmi, .relative)
    ...
    func testElseNewPage() throws {
        ...
        nes.cpu.registers.signFlag = false
        nes.memory.storage[0x00FE] = nes.cpu.opcode(.bmi, .relative)

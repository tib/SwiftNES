...
final class BNETests: XCTestCase {
    ...
    func testIf() throws {
        ...
        nes.memory.storage[0x00] = nes.cpu.opcode(.bne, .relative)
    ...
    func testIfNewPage() throws {
        ...
        nes.cpu.registers.zeroFlag = false
        nes.memory.storage[0x00FC] = nes.cpu.opcode(.bne, .relative)
    ...
    func testIfBackwards() throws {
        ...
        nes.cpu.registers.pc = 0x00FC
        nes.cpu.registers.zeroFlag = false
        nes.memory.storage[0xFC] = nes.cpu.opcode(.bne, .relative)
    ...
    func testElseNewPage() throws {
        ...
        nes.cpu.registers.zeroFlag = true
        nes.memory.storage[0x00FE] = nes.cpu.opcode(.bne, .relative)

...
final class BVSTests: XCTestCase {
    ...
    func testIf() throws {
        ...
        nes.memory.storage[0x00] = nes.cpu.opcode(.bvs, .relative)
    ...
    func testIfNewPage() throws {
        ...
        nes.cpu.registers.overflowFlag = true
        nes.memory.storage[0x00FC] = nes.cpu.opcode(.bvs, .relative)
    ...
    func testIfBackwards() throws {
        ...
        nes.cpu.registers.pc = 0x00FC
        nes.cpu.registers.overflowFlag = true
        nes.memory.storage[0xFC] = nes.cpu.opcode(.bvs, .relative)
    ...
    func testElseNewPage() throws {
        ...
        nes.cpu.registers.overflowFlag = false
        nes.memory.storage[0x00FE] = nes.cpu.opcode(.bvs, .relative)
